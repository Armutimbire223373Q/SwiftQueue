    ...
    <div class="auth-container">
      <div class="auth-card">
        ...
        <div class="auth-header">
          ...
          <h1>Join SwiftQueue</h1>
          <p>Create your hospital staff account</p>
        </div>
        ...
        <form class="auth-form" (ngSubmit)="onRegister()" #registerForm="ngForm">
          ...
          <div class="form-group">
            ...
            <div class="form-error" *ngIf="registerData.password !== registerData.confirmPassword && confirmPassword.touched">
